...
client2.on('message', async msg => { // eslint disable line
    ...
    if (msg.content.startsWith(`${PREFIX2}play`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX2}play command in ${msg.guild.name}`);
...
client.on('ready', () => {
  ...
  console.log('[        info         ]')
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
  console.log(`servers! [ " ${client4.guilds.size} " ]`);
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
  console.log(`Users! [ " ${client4.users.size} " ]`);
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
  console.log(`channels! [ " ${client4.channels.size} " ]`);
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
});
 
 
client4.on('disconnect', () => console.log('I just disconnected, making sure you know, I will reconnect now...'));
 
client4.on('reconnecting', () => console.log('I am reconnecting now!'));
 
client4.on('message', async msg => { // eslint disable line
    if (msg.author.bot) return undefined;
    if (!msg.content.startsWith(PREFIX4)) return undefined;
    const args = msg.content.split(' ');
    const searchString = args.slice(1).join(' ');
    const url = args[1] ? args[1].replace(/<(.+)>/g, '$1') : '';
    const serverQueue = queue.get(msg.guild.id);
 
    if (msg.content.startsWith(`${PREFIX4}play`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}play command in ${msg.guild.name}`);
    ...
    } else if (msg.content.startsWith(`${PREFIX4}skip`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}skip command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        serverQueue.connection.dispatcher.end();
        return undefined;
    } else if (msg.content.startsWith(`${PREFIX4}stop`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}stop command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        serverQueue.connection.dispatcher.end('Stop command has been used!');
        return undefined;
    } else if (msg.content.startsWith(`${PREFIX4}volume`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}volume command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
    ...
    } else if (msg.content.startsWith(`${PREFIX4}np`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}np command in ${msg.guild.name}`);
        if (!serverQueue) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
    ...
    } else if (msg.content.startsWith(`${PREFIX4}queue`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}queue command in ${msg.guild.name}`);
        if (!serverQueue) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        } else if(msg.content.startsWith(`${PREFIX4}help`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}help command in ${msg.guild.name}`);
        ...
        msg.author.send({embed: {
            ...
            fields: [{
                name: "Bot's commands:",
                value: `**${PREFIX4}help** - This message!\n\
**${PREFIX4}play** - Play a song from YouTube.\n\
**${PREFIX4}skip** - Skip a song.\n\
**${PREFIX4}stop** - Stops the music.\n\
**${PREFIX4}volume** - Change the volume of the bot.\n\
**${PREFIX4}np** - The song that now playing.\n\
**${PREFIX4}queue** - See the queue of songs.\n\
**${PREFIX4}pause** - Pause the music.\n\
**${PREFIX4}resume** - Resume the music.`
              }
            ],
            timestamp: new Date(),
            footer: {
    ...
    } else if (msg.content.startsWith(`${PREFIX4}pause`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}pause command in ${msg.guild.name}`);
        if (serverQueue && serverQueue.playing) {
            serverQueue.playing = false;
        serverQueue.connection.dispatcher.pause();
        return msg.channel.send({embed: {
    ...
    } else if (msg.content.startsWith(`${PREFIX4}resume`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX4}resume command in ${msg.guild.name}`);
...
if (message.content.startsWith(PREFIX4 + 'setavatar')) {
...
client2.on('ready', () => {
  ...
  console.log('[        info         ]')
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
  console.log(`servers! [ " ${client5.guilds.size} " ]`);
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
  console.log(`Users! [ " ${client5.users.size} " ]`);
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
  console.log(`channels! [ " ${client5.channels.size} " ]`);
  console.log('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
});
 
 
client5.on('disconnect', () => console.log('I just disconnected, making sure you know, I will reconnect now...'));
 
client5.on('reconnecting', () => console.log('I am reconnecting now!'));
 
client5.on('message', async msg => { // eslint disable line
    if (msg.author.bot) return undefined;
    if (!msg.content.startsWith(PREFIX5)) return undefined;
    const args = msg.content.split(' ');
    const searchString = args.slice(1).join(' ');
    const url = args[1] ? args[1].replace(/<(.+)>/g, '$1') : '';
    const serverQueue = queue.get(msg.guild.id);
 
    if (msg.content.startsWith(`${PREFIX5}play`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}play command in ${msg.guild.name}`);
    ...
    } else if (msg.content.startsWith(`${PREFIX5}skip`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}skip command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        serverQueue.connection.dispatcher.end();
        return undefined;
    } else if (msg.content.startsWith(`${PREFIX5}stop`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}stop command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        serverQueue.connection.dispatcher.end('Stop command has been used!');
        return undefined;
    } else if (msg.content.startsWith(`${PREFIX5}volume`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}volume command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
    ...
    } else if (msg.content.startsWith(`${PREFIX5}np`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}np command in ${msg.guild.name}`);
        if (!serverQueue) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
    ...
    } else if (msg.content.startsWith(`${PREFIX5}queue`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}queue command in ${msg.guild.name}`);
        if (!serverQueue) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        } else if(msg.content.startsWith(`${PREFIX5}help`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}help command in ${msg.guild.name}`);
        ...
        msg.author.send({embed: {
            ...
            fields: [{
                name: "Bot's commands:",
                value: `**${PREFIX5}help** - This message!\n\
**${PREFIX5}play** - Play a song from YouTube.\n\
**${PREFIX5}skip** - Skip a song.\n\
**${PREFIX5}stop** - Stops the music.\n\
**${PREFIX5}volume** - Change the volume of the bot.\n\
**${PREFIX5}np** - The song that now playing.\n\
**${PREFIX5}queue** - See the queue of songs.\n\
**${PREFIX5}pause** - Pause the music.\n\
**${PREFIX5}resume** - Resume the music.`
              }
            ],
            timestamp: new Date(),
            footer: {
    ...
    } else if (msg.content.startsWith(`${PREFIX5}pause`)) {
        console.log(`${msg.author.tag} has been used the ${PREFIX5}pause command in ${msg.guild.name}`);
        if (serverQueue && serverQueue.playing) {
            serverQueue.playing = false;
        serverQueue.connection.dispatcher.pause();
        return msg.channel.send({embed: {
